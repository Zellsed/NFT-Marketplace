...
import Style from "./NFTCollectionDetailsPage.module.css";
...
const NFTReSellCollectiondetailsDetailPage = ({ nft }) => {
...
export default NFTReSellCollectiondetailsDetailPage;
